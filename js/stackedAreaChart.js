...
StackedAreaChart.prototype.initVis = function(){
  ...
  // SVG drawing area
    ...
    vis.svg.append('text').attr("transform", "translate(10,0)").classed('tip', true);
...
StackedAreaChart.prototype.updateVis = function(){
    ...
    vis.svg.selectAll(".area").on('mouseover', (e, d)=>{
        vis.svg.selectAll(".tip").text(d.key);
    }).on('mouseleave', (e, d)=>{
        vis.svg.selectAll(".tip").text('');
    })
